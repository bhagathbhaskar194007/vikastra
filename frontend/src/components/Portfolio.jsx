          ...
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-cyan-400 mb-2">
                  {p.cat}
                </div>
              ...
              {/* Hover border accent */}
              <div className="absolute inset-0 rounded-2xl border border-white/10 group-hover:border-cyan-400/50 transition-colors duration-500 pointer-events-none" />
            </motion.a>
          ))}
        </div>
      </div>
