    ...
    >
      <div className="container-vk flex items-center justify-between h-16 md:h-20">
        <a href="#top" data-testid={NAV.logo} className="flex items-center gap-3 group">
          <div className="relative w-9 h-9 grid place-items-center rounded-lg bg-gradient-to-br from-cyan-400 to-purple-500 glow-cyan">
            <span className="font-display text-lg font-black text-[#05050A]">V</span>
            <div className="absolute inset-0 rounded-lg bg-gradient-to-br from-cyan-400 to-purple-500 blur-md opacity-50 group-hover:opacity-80 transition" />
          </div>
        ...
        <a
          href="#contact"
          data-testid={NAV.cta}
          className="hidden md:inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold text-[#05050A] bg-gradient-to-r from-cyan-300 to-cyan-500 hover:shadow-[0_0_20px_rgba(0,229,255,0.5)] transition-all"
        >
          Get Started
        </a>
            ...
            <nav className="container-vk py-6 flex flex-col gap-4">
              {links.map((l) => (
                <a
                  ...
                  className="text-base text-slate-200 hover:text-cyan-400 transition py-2"
                >
                  {l.label}
                </a>
              ))}
              <a
                href="#contact"
                onClick={() => setOpen(false)}
                className="mt-2 inline-flex justify-center items-center rounded-full px-5 py-3 text-sm font-semibold text-[#05050A] bg-gradient-to-r from-cyan-300 to-cyan-500"
              >
                Get Started
              </a>
            </nav>
