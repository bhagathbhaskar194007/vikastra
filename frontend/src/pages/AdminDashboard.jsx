...
const statusStyle = {
  new: "bg-cyan-400/10 text-cyan-300 border-cyan-400/30",
  contacted: "bg-purple-400/10 text-purple-300 border-purple-400/30",
...
export default function AdminDashboard() {
  ...
  const statCards = [
    { label: "Total Leads", value: stats.total, icon: Inbox, color: "from-cyan-400 to-blue-500" },
    { label: "New", value: stats.new, icon: Clock, color: "from-purple-400 to-pink-500" },
    { label: "Contacted", value: stats.contacted, icon: PhoneCall, color: "from-orange-400 to-rose-500" },
    { label: "Last 7 days", value: stats.recent_7d, icon: CheckCircle2, color: "from-emerald-400 to-cyan-500" },
  ];
      ...
      <header className="sticky top-0 z-30 bg-[#05050A]/85 backdrop-blur-xl border-b border-white/5">
        <div className="container-vk flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-cyan-400 to-purple-500 grid place-items-center glow-cyan">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={refresh}
              disabled={busy}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 hover:border-cyan-400/40 text-sm text-slate-300 hover:text-white transition"
            >
            ...
            <div className="divide-y divide-white/5 max-h-[640px] overflow-y-auto">
              {filtered.length === 0 ? (
                ...
                filtered.map((lead) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-cyan-400/30 to-purple-500/30 grid place-items-center font-display font-bold text-white shrink-0">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {lead.service && (
                        <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-cyan-400/80 mt-1">
                          {lead.service}
                        </div>
                      )}
                    </div>
              ...
              <>
                ...
                <div className="space-y-3 mb-6">
                  <a
                    ...
                    className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5 hover:border-cyan-400/40 transition"
                  >
                  ...
                  {selected.phone && (
                    <a
                      ...
                      className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5 hover:border-purple-400/40 transition"
                    >
